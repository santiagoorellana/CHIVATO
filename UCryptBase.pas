...
if (Size <= 0) or ((Size and 3)<> 0) or (Size> longword(GetMaxKeySize)) then
   raise EDCP_cipher.Create(DecStr('V/9bDn>bQòIp1!Ae9fD!Em:mGbIw>fH!PoMp6!VwBâNmGjFeEpNUU'))    //'Tamaño de llave no válido.'
else
   fInitialized:= true;
end;
...
try
   ...
   raise EDCP_cipher.Create(DecStr('G/IpS!At0fW!1qNvVf:eKfW!Pb2m4p?kUb8sW!HtYvQg@j1d0jIfQoCuEfO!Wn;f6n5pYs5j>b6OA'));  //'No se puede alojar suficiente memoria.'
end;
end;
